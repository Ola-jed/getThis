@foreach($articles as $article)
    <div class="article box">
        ...
        <p class="article-author"><a href="{{ url('/profile/'.$article->writer_id) }}">{{ \App\Models\User::find($article->writer_id)->name }}</a>, the {{ date('F j, Y H:i:s', strtotime($article->created_at)) }}</p>
