@foreach($articles as $article)
    <div class="article box">
        ...
        <p class="article-author"><a href="{{ url('/profile/'.\App\Models\User::find($article->writer_id)->id) }}">{{ \App\Models\User::find($article->writer_id)->name }}</a>, the {{ date('F j, Y', strtotime($article->created_at)) }}</p>
